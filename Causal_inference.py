...
def parse_args():
    ...
    parser.add_argument('--gpus', type=int, default='', help='number of gpus to use')
    ...
    parser.add_argument('--trainset', type=str, default='',help='path to the train set')
    parser.add_argument('--patch_size', type=int, default=64)
    parser.add_argument('--testset', type=str, default='', help='path to the test set')

    parser.add_argument('--save_every', type=int, default=50, help='save weights')
    parser.add_argument('--test_every', type=int, default=5, help='save weights')
    parser.add_argument('--print_every', type=int, default=100)
    parser.add_argument('--batch_size', type=int, default=16, help='input batch size for training')
    parser.add_argument('--num_workder', type=int, default=24)
...
def main():
    ...
    testset = srdata_noise.DataTest(hr_folder=args.testset, level='')  # different sampling rate or noise 50 ,70
